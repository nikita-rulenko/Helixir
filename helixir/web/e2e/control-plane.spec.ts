...
async function mockAdminApi(page: Page) {
  await page.route("**/api/v1/**", async route => {
    ...
    if (path === "/meta") return json(route, { product: "helixir", version: "0.15.0", api_version: "v1", phase: "admin", transport: "http", runtime: "control-plane-container", host_operations_available: true });
