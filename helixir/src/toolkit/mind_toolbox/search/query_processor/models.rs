...
impl ProcessedQuery {
    ...
    pub fn to_dict(&self) -> HashMap<String, serde_json::Value> {
        ...
        map.insert(
            ...
            serde_json::Value::String(self.original_query.clone()),
        );
        map.insert(
            "enhanced_query".to_string(),
            serde_json::Value::String(self.enhanced_query.clone()),
        );
        map.insert(
            "detected_intents".to_string(),
        ...
        map.insert(
            "suggested_mode".to_string(),
            match &self.suggested_mode {
        ...
        map.insert(
            ...
            serde_json::Value::Number(
                serde_json::Number::from_f64(self.confidence)
