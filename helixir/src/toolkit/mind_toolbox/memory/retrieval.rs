...
impl ContextAssembler {
    ...
    pub async fn gather_context(
        ...
        if include_reasoning {
            ...
            if let Ok(relations) = self
                .client
                .execute_query::<Vec<RelationData>, _>(
        ...
        if include_entities {
            ...
            if let Ok(entity_list) = self
                .client
                .execute_query::<Vec<EntityData>, _>(
                    "getMemoryEntities",
                    &GetEntitiesParams {
                        memory_id: memory_id.to_string(),
                    },
    ...
    pub async fn retrieve(
        ...
        if depth != RetrievalDepth::Shallow {
            for memory in &mut memories {
                match self
                    .reconstructor
                    .reconstruct_memory(&memory.memory_id)
                    .await
                {
